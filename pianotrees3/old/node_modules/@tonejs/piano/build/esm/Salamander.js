...
export var githubURL = 'https://tambien.github.io/Piano/Salamander/';
...
export function getNotesInRange(min, max) {
    return allNotes.filter(function (note) { return min <= note && note <= max; });
}
/**
 * All the notes of audio samples
 */
...
export function getHarmonicsInRange(min, max) {
    return harmonics.filter(function (note) { return min <= note && note <= max; });
}
